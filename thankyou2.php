...
$subject = "Your profile submission acknowledgement for Training Opportunity";
$body = "Dear " .$name.","."<br><br>"."Thanks for sharing your profile. One of our managers will be contacting you shortly and do the needful.<br><br>With Regards,<br>ArrisTraining Team<br>www.arrisventures.in";
...
if($pp!="")
{
  $res="Please find the profile pasted for your kind perusal and further processing.";
  $pst=$_POST['pasteprofile'];
}
else {
  $res="Please find the profile attached for your kind perusal and further processing.";
