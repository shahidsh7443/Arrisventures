...
<title>Home || ArrisWellness </title>
...
<body>
  ...
  <!-- splash image -->
  <div class="container">
<img src="img/Home/WellnessWebPage.jpg" title="ArrisWellness" alt="ArrisWellness"/ class="trainingimg wellbanner">
  </div>
  ...
  <div class="row-fluid">
        <div class="text_content span10 offset1">
          <!--Text Content-->
<h1>Wellness</h1>
  <p>Due to changes in environment & food, various pollutions and infections, human body is prone to various types of pain irrespective of the age. Even on liberal spending on pain balms, availability of guaranteed pain killer medicine is not sure to get. However even today we are fortunate to have native medicines in a distant, remote villages and hilly areas, which will have magical power of removing pains and other diseases. One such herbal oil is manufactured by us which removes all type of pains like Arthritis, Knee Pain, Chikungunya Pain, Neck Pain, Shoulder Pain, Wrist Pain, Ankle Pain, Toe Pain, Back Pain, Elbow Pain, Arm Pain, Hip Pain etc and gives remarkable relief after a few applications. Few drops of application of oil and gentle massage will help to remove the pain. Those who are disappointed by trying many balms can confidently use this oil and get the pain eradicated.
