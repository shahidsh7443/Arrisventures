...
<title>Benefits || ArrisEvaluation </title>
...
<body>
  ...
  <div class="row-fluid">
        ...
        <div class="span7 spaan7"><!--Navigation-->
          ...
          <li><a href="arrisevaluation.php" class="tooltip1">Home<span class="hidden-phone tt">The Genesis</span></a></li>
            <li  class="selected "><a href="benefits.php" class="tooltip1"><span>Benefits</span><span class="hidden-phone tt">Our Edge</span></a>
            </li>
  ...
  <div class="row-fluid">
        <div class="text_content span10 offset1 skill1">
          <!--Text Content-->
          <h1>Benefits</h1>
