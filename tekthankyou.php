		...
		$email= $_POST['email'];
		$msg= $_POST['msg'];
		$subject = "Request for information regarding ArrisTrraining";
                $body ="<html><body>";
		...
		$success=mail("info@arristeck.com",$subject,$body,$headers);
                  ...
                  $body = "Dear " .$name.","."<br><br>"."Thanks for contacting us. One of our representatives will be contacting you shortly and do the needful.<br><br>With Regards,<br>ArrisTrraining Team<br>Mobile : 7353775774<br>www.arrisventures.in";
                  // Always set content-type when sending HTML email
                  $headers = "MIME-Version: 1.0" . "\r\n";
                  $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
