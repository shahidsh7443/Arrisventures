...
<title>Products || ArrisWellness </title>
...
<body>
	...
	<div class="row-fluid">
        ...
        <div class="span7 spaan7 welsp" ><!--Navigation-->
          ...
          <li ><a href="arriswellness.php" class="tooltip1">Home<span class="hidden-phone tt">The Genesis</span></a></li>
            <li class="selected "><a href="products.php" class="tooltip1"><span>Products</span><span class="hidden-phone tt">Our Assets</span></a>
            </li>
            ...
            <li><a href="wegroup.php" class="tooltip1">About<span class="hidden-phone tt">Our Intent</span></a></li>
  ...
  <div class="row-fluid">
        <div class="text_content span10 offset1" style="margin-bottom: 65px;">
          <!--Text Content-->
<h1>Products</h1>
  <p>Under brand HERBOL, it is pure and highly effective homemade pain reliever oil prepared as per the native preparatory formula using herbs combined in the required proportion to trigger a positive emotional and physical ability to reduce inflammation on the affected area. HERBOL gives you what you want and deserve - a pain-free life back as gently, effectively, and quickly as possible.
</p>
<p class="sep"><p/>
  <p>Currently, we are manufacturing the following three types of Pain Reliever Oil.
</p>
<div class="row-fluid">
  <div class="col-lg-4 cs">
<h3>General Body Pain</h3>
<img src="img/GeneralFront.jpg" alt="General Body Pain" style="width:400px;height:auto;"></div>
<div class="col-lg-4 cs">
  <h3>Knee Injuries & Pain</h3>
  <img src="img/KneeFront.jpg" alt="Knee Injuries & Pain" style="width:400px;height:auto;"></div>
<div class="col-lg-4 cs cs2">
  <h3>Arthritis & Chikungunya Pain</h3>
  <img src="img/ArtFront.jpg" alt="Arthritis & Chikungunya Pain" style="width:400px;height:611px;"></div>
</div>
<div class="row-fluid oils">
  <div class="col-lg-4 cs">
<img src="img/GenralBack.jpg" alt="General Body Pain" style="width:400px;height:auto;"></div>
<div class="col-lg-4 cs">
  <img src="img/KneeBack.jpg" alt="Knee Injuries & Pain" style="width:400px;height:auto;"></div>
<div class="col-lg-4 cs cs2">
  <img src="img/ArtBack.jpg" alt="Arthritis & Chikungunya Pain" style="width:400px;height:611px;"></div>
</div>
       </div>
    </div>
 </div>
