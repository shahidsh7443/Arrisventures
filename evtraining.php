...
if(isset($_POST)) {
	...
	$hire= $_POST['hire'];
	$msg= $_POST['com'];
	$subject = "Your request acknowledgement for Technical Evaluation";
...
$body .="<table>";
$body .="<tr><td>Name</td><td style='display: table-cell;'>:</td><td> &nbsp;" . $_POST['name'] . "</td></tr>";
...
$body .="<tr><td style='display: inline-block;overflow: hidden;white-space: nowrap;'>Industry Serviced</td><td style='display: table-cell;'>:</td><td> &nbsp;" . $_POST['hire'] . "</td></tr>";
