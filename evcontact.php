...
<title>Contact || ArrisEvaluation </title>
...
$.ajax({
            ...
            error: function( aa ){
              $("#esend").closest("div").append("<span class='error' style='color:White;font-weight:600;display:inline-block;font-size:15px;position:  absolute;margin-top: -28px;margin-left: -179px;'>Thank you for contacting us</span>");
              $('#econt')[0].reset();
            }
        });
  ...
  <div class="row-fluid">
        ...
        <div class="span7 spaan7"><!--Navigation-->
          ...
          <li ><a href="arrisevaluation.php" class="tooltip1">Home<span class="hidden-phone tt">The Genesis</span></a></li>
            ...
            <li class="selected "><a href="evcontact.php" class="tooltip1">Contact<span class="hidden-phone tt">Get Started</span></a></li>
          </ul>
        </div>
  	</div>
  <!-- *************** Main Content Area ******************** -->
...
<p class="sep"></p>
        ...
        <div class="span12">
          ...
          <h1 id="form_title">Contact Us</h1>
              ...
              <form  method="post" id="econt" novalidate>
              	<div id="success_msg">
				...
				//unset($_SESSION['error_msg']);?>
                    ...
                    <div class="row-fluid vrf">
                        ...
                        <div class="span4"><input type="text" name="location" id="location" pattern="^[a-zA-Z][a-zA-Z ]+[a-zA-Z]|[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact()" maxlength="20" required/></div>
                    </div>
                    <div class="row-fluid">
                    	<div class="span2"><label>Mobile*</label></div>
                        <div class="span4"><input type="text" name="mobile" pattern="^[789]\d{9}$" id="mobile" maxlength="20" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact()" required/></div>
...
<div class="span12 center" style="margin-top:  25px;">
                <button type="submit" value="SUBMIT" id="esend" name="submit" /*onclick="send_mail1_contact()"*/ style="
