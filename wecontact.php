...
<title>Contact || ArrisWellness </title>
...
$.ajax({
            ...
            error: function( aa ){
              $("#wesend").closest("div").append("<span class='error' style='color:White;font-weight:600;display:inline-block;font-size:15px;position:  absolute;margin-top: -28px;margin-left: -179px;'>Thank you for contacting us</span>");
              $('#wecon')[0].reset();
            }
        });
	...
	<div class="row-fluid">
        ...
        <div class="span7 spaan7 welsp"><!--Navigation-->
          ...
          <li ><a href="arriswellness.php" class="tooltip1">Home<span class="hidden-phone tt">The Genesis</span></a></li>
            ...
            <li class="selected "><a href="wecontact.php" class="tooltip1">Contact<span class="hidden-phone tt">Get Started</span></a></li>
          </ul>
        </div>
...
<p class="sep"></p>
        ...
        <div class="span12">
          ...
          <h1 id="form_title">Contact Us</h1>
              ...
              <form  method="post" id="wecon" novalidate>
              	<div id="success_msg">
				...
				//unset($_SESSION['error_msg']);?>
                    ...
                    <div class="row-fluid vrf">
                        ...
                        <div class="span4"><input type="text" name="name" id="name" pattern="^[a-zA-z]{2,3}[\.][a-zA-Z][a-zA-Z ]+[a-zA-Z]|[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact()"  maxlength="20" required/></div>
                        <div class="span2"><label>Location* </label></div>
                        <div class="span4"><input type="text" name="location" maxlength="20" id="location" pattern="^[a-zA-Z][a-zA-Z ]+[a-zA-Z]|[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" onkeyup="send_mail1_contact(this.id)" required/></div>
                    </div>
                    <div class="row-fluid">
                    	<div class="span2"><label>Mobile*</label></div>
                        <div class="span4"><input type="text" name="mobile" id="mobile" maxlength="20" pattern="^[789]\d{9}$" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact()"  required/></div>
                        <div class="span2"><label>Email Id*</label></div>
                        <div class="span4"><input type="text" name="email" id="email" pattern="^[^\s@]+@[^\s@]+\.[^\s@]+$" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact()"  required/></div>
                    </div>
                    <div class="row-fluid"><br />
                    	<div class="span2 offset5 ctm"  style="text-align:left;margin-bottom:0.5em;"><label>Message*</label></div>
                    </div>
                    <div class="row-fluid">
                    	<div class="span12"><textarea id="msg" name="msg" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact()"  required></textarea></div>
                    </div>
                    <div class="row-fluid">
<div class="span12 center" style="margin-top:  25px;">
                <button type="submit" value="SUBMIT" id="wesend" name="submit" onclick="send_mail1_contact()" style="
