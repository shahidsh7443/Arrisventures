...
<title>Benefits || ArrisWellness </title>
	...
	<div class="row-fluid">
        ...
        <div class="span7 spaan7 welsp"><!--Navigation-->
          ...
          <li ><a href="arriswellness.php" class="tooltip1">Home<span class="hidden-phone tt">The Genesis</span></a></li>
            ...
            <li class="selected "><a href="benefitts.php" class="tooltip1"><span>Benefits</span><span class="hidden-phone tt">Our Edge</span></a>
            </li>
...
<div class="container">
<ul class="ben">
<li>Homemade proprietary medicine</li>
<li>No harmful side effects</li>
<li>Made out of natural herbs</li>
<li>External application</li>
<li>Non-allergic product</li>
<li>100 % chemical free</li>
<li>Removes pain remarkably</li>
<li>Effective for all kinds of body pain, muscle spasm & sprain.</li>
