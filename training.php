...
<title>Training || ArrisTrraining </title>
...
$("#trbt").closest("div").append("<span class='error' style='color:White;font-weight:600;display:inline-block;font-size:15px;position:  absolute;margin-top: -100px;margin-left: 330px;'>Your Profile has been submitted successfully</span>");
                  $('#trf')[0].reset();
               },
                error: function( aa ){
                  $("#trbt").closest("div").append("<span class='error' style='color:White;font-weight:600;display:inline-block;font-size:15px;position:  absolute;margin-top: -100px;margin-left: 330px;'>Please Fill all the fields.</span>");
                }
            });
...
<!--<style>
.fileupload-exists .fileupload-exists {
...
<h2 id="form_title" style="color:white;">WOULD YOU LIKE TO EXPLORE FREELANCE TRAINING OPPORTUNITIES?</h2>
    ...
    <form  method="post"  name="trform" id="trf" enctype='multipart/form-data' novalidate>
      <div id="success_msg">
...
//unset($_SESSION['error_msg']);?>
  	...
  	<div class="form-group  col-sm-6">
  		 <input  class="form-control" maxlength="20" id="location" name="location" placeholder="*Location" pattern="^[a-zA-Z][a-zA-Z ]+[a-zA-Z]|[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact(this.id)" required/>
  	</div>
  	<div class="form-group  col-sm-6">
  		 <input  style="margin-top: 0px;"  class="form-control" maxlength="20" id="mobile" name="mobile" placeholder="*Mobile Number" pattern="^[789]\d{9}$" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact(this.id)" required/>
  	</div>
  	<div class="form-group  col-sm-6">
  		 <input  style="margin-top: 0px;margin-bottom:0px;" maxlength="50" type="email" class="form-control" id="email" name="email" placeholder="*Email Id" pattern="^[^\s@]+@[^\s@]+\.[^\s@]+$" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact(this.id)" required/>
  	</div>
  	</div>
  	<div class="col-sm-4 nocolrightpad">
  	<div class="col-sm-12">
  		 <textarea  rows="5" maxlength="500" class="form-control" id="msg" name="msg" placeholder="*Message" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact(this.id)" required></textarea>
  	</div>
  	</div>
  </div>
      ...
      <!--<div class="col-lg-12">
        <div class="form-group">
          ...
          <div class="col-sm-8 form-group">
    		<input  type="file" id="profile" name="profile" accept=".docx, .pdf, .rtf,.doc" style="margin-left:-35px;"/></div>
    		</div>
      </div>-->
...
">Change</span>
    ...
    cursor: pointer;
    height:  35px;
"></span><a id="_s_remove" class="btn fileupload-exists" onclick="remove();" style="display:none;padding: 4px 7px 4px 8px;">Remove</a>
</div>
</div>-->
...
">
        			...
        			<button type="reset" value="Reset" id="trbt" onclick="$('.error').hide();" class="btn btn-warning rst" style="margin-top:25px;height:40px;font-size:18px;width:125px;">Reset</button>
        		</div>
        	</div>
    </form>
