...
$.ajax({
                ...
                $("#cbtn").closest("div").append("<span class='error' style='color:White;font-weight:600;display:inline-block;font-size:15px;position:  absolute;margin-top: -28px;margin-left: -179px;'>Thank you for contacting us</span>");
                  $('#contf')[0].reset();
								
               },
                error: function( aa ){
                  $("#cbtn").closest("div").append("<span class='error' style='color:White;font-weight:600;display:inline-block;font-size:15px;position:  absolute;margin-top: -28px;margin-left: -179px;'>Failed</span>");
	...
	<div class="row-fluid">
        ...
        <div class="span7"><!--Navigation-->
          <ul id="nav">
            ...
            <li class="selected active"><a href="contact.php" class="tooltip1">Contact<span class="hidden-phone tt">Get Started</span></a></li>
          </ul>
        </div>
...
<p class="sep"></p>
        ...
        <div class="span12">
          ...
          <h1 id="form_title">Contact Us</h1>
              ...
              <form  method="post"  id="contf" novalidate>
              	<div id="success_msg">
				...
				//unset($_SESSION['error_msg']);?>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="span4"><input type="text" name="mobile" id="mobile" maxlength="20" pattern="^[789]\d{9}$" onkeyup="send_mail1_contact(this.id)"onclick="send_mail1_contact(this.id)"  required/></div>
                        <div class="span2"><label>Email Id*</label></div>
                        <div class="span4"><input type="email" name="email" id="email" pattern="^[^\s@]+@[^\s@]+\.[^\s@]+$" onkeyup="send_mail1_contact(this.id)" onclick="send_mail1_contact(this.id)" required/></div>
                    </div>
                ...
                <button type="submit" value="SUBMIT" id="cbtn" name="submit" /*onclick="send_mail1_contact()"*/ style="
