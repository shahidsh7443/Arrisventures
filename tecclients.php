...
<title>Clients || ArrisTrraining </title>
...
<div class="row-fluid tcc">  <!--action="http://projects.razorbee.com/arrisventures/ctraining.php" target="_blank" /arristechn/ctraining.php-->
  <form id="form"  name="form" method="POST" class="tcform" novalidate>
    <h2 id="form_title" style="color:white;background-color: #01babd;margin-bottom:50px;">LOOKING FOR CORPORATE TRAINING?</h2>
  	<div class="form-group">
  		<div class="col-sm-6">
  			<input type="text" class="form-control" maxlength="50" id="namef" name="namef" pattern="^[a-zA-Z][\']{1}[a-zA-Z]|[a-zA-Z][a-zA-Z]$" placeholder="*Enter First Name" onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/>
  		</div>
  		<div class="col-sm-6 get_hire">
  			<input type="text" class="form-control" maxlength="50" id="namel" name="namel" pattern="^[a-zA-Z][\']{1}[a-zA-Z]|[a-zA-Z][a-zA-Z]$" placeholder="Enter Last Name" onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/>
  		</div>
  	</div>
  	<div class="form-group">
  		<div class="col-sm-6">
  			<input  class="form-control" maxlength="20" id="mobile" name="mobile" pattern="^[789]\d{9}$" placeholder="*Enter Mobile Number" onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/>
  		</div>
  		<div class="col-sm-6 get_hire">
  			<input type="email" class="form-control" id="email" maxlength="50" name="email" pattern="^[^\s@]+@[^\s@]+\.[^\s@]+$" placeholder="*Enter Email Id" onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/>
  		</div>
  	</div>
  	<div class="form-group">
  		<div class="col-sm-6">
  			<input type="text" class="form-control" maxlength="50" id="compname" name="compname"  pattern="^[a-zA-Z0-9][-./&+\w\s]*$" placeholder="*Enter Company Name" onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/>
  		</div>
  		<div class="col-sm-6 get_hire">
  			<input style="" type="text" class="form-control" maxlength="100" id="compurl" name="compurl" pattern="^(https\:\/\/|http\:\/\/|www\.|)[a-zA-Z0-9\-\.]+\.(com|org|net|mil|edu|COM|ORG|NET|MIL|EDU|co.in|uk)*$"  placeholder="*Enter Company URL" onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/>
  		</div>
  	</div>
  	<div class="form-group">
  		<div class="col-sm-6">
  			<input type="text" class="form-control" maxlength="20" id="cloc" name="cloc" pattern="^[a-zA-Z][a-zA-Z ]+[a-zA-Z]|[a-zA-Z][a-zA-Z ]+[a-zA-Z]$" placeholder="*Enter Company Location" onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/>
  		</div>
  		<div class="col-sm-6 get_hire">
  			<input type="text" class="form-control" maxlength="50" id="desig" name="desig" pattern="^[a-zA-Z][a-zA-Z0-9 ]+[a-zA-Z0-9\.]*$" placeholder="*Enter Deisignation" onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/>
  		</div>
  	</div>
  	<div class="form-group">
  		<div class="col-sm-6">
  			<input type="text" class="form-control" maxlength="50" id="hire" name="hire"  placeholder="Enter Industry Serviced" onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/>
  		</div>
  		<div class="col-sm-6 get_hire">
...
<option value="Campus to Corporate Training">Other Training</option>
  	...
  	<div class="form-group">
  		<div class="col-sm-12 tct">
  			<textarea style="width:100%;" rows="6" cols="44" id="com" name="com"  maxlength="1000"  placeholder="*Enter Comment..." onkeyup="send_mail2_contact(this.id);" onclick="send_mail2_contact(this.id);" required/></textarea>
  		</div>
  	</div>
